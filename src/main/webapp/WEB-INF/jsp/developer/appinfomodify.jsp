...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="updateApp" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div id="logoFile">
<!-- 	                 <img src="${appInfo.logoPicPath }" id="img3" style="width: 60px;height: 6s0px;"/> <a href="javascript:;" onclick="delfile('${appInfo.id}');">删除</a> -->
<!-- 	                 <input type="file" id="file" name="a_logoPicPath"  id="a_logoPicPath" onchange="changepic(this)" accept="image/jpg,image/jpeg,image/png,image/PNG"> -->
<!-- 	                  -->
                 </div>
                 ${fileUploadError }
            </div>
