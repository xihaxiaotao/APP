    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="updateAppVersion" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
			...
			<div id="uploadfile" style="display: none">
				<input id="attach" type="file" class="form-control col-md-7 col-xs-12" name="a_apkFile">
