  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
	  ...
	  <!-- <div class="item form-group">
           ...
           <div class="clearfix"></div>
        <form class="form-horizontal form-label-left" modelAttribute="appInfo" action="${pageContext.request.contextPath }/app/dev/addApp" method="post" enctype="multipart/form-data">
          <div class="item form-group">
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <span id="span10" style="color: red"> ${fileUploadError }</span>
          </div>
