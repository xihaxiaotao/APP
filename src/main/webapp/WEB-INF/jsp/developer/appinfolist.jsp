...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/app/dev/applist">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper" "
				...
				<div class="row">
					<div class="col-sm-12">
					<input type="hidden" value="${querySoftwareName }" id="softwareName">
					<input type="hidden" value="${queryStatus }" id="status">
					<input type="hidden" value="${queryFlatformId }" id="flatformId">
					<input type="hidden" value="${queryCategoryLevel1 }" id="categoryLevel1">
					<input type="hidden" value="${queryCategoryLevel2 }" id="categoryLevel2">
					<input type="hidden" value="${queryCategoryLevel3 }" id="categoryLevel3">
					<input type="hidden" id="pageIndex2" value="${pages.currentPageNo }" />
					<a href="${pageContext.request.contextPath}/app/dev/toAddApp" class="btn btn-success btn-sm">新增APP基础信息</a>
					<a href="javascript:void(0)" class="btn btn-success btn-sm"  id="exportAll">导出所有数据</a>
					<a href="javascript:void(0)" class="btn btn-success btn-sm"  id="exportThis">导出本页数据</a>
					<a href="${pageContext.request.contextPath}/app/dev/toAppEchartsData" class="btn btn-success btn-sm">查看数据图</a>
					...
					<div class="btn-group">
<!-- 					<span class="btn btn-danger">点击操作</span> -->
